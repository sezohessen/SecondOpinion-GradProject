...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form action="{{route("dashboard.doctor.update",$doctor->id)}}" method="POST" enctype='multipart/form-data' >
            @csrf
            @method('PATCH')
            ...
            <div class="card-body">
             ...
             <div class="form-group">
                 <input id="first_name" type="text" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6 @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') ?? $doctor->user->first_name }}" required autocomplete="first_name" autofocus placeholder="@lang('first name')">
                 @error('first_name')
             ...
             <!--end::Form group-->
             <div class="form-group">
                 <input id="email" type="email" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6 @error('email') is-invalid @enderror" name="email" value="{{ old('email')  ?? $doctor->user->email }}" required autocomplete="email"  placeholder="@lang('Email')">
                 @error('email')
                     <div class="fv-plugins-message-container">
                         <div class="fv-help-block">
                             <strong>{{ $message }}</strong>
             ...
             <div class="form-group">
                <input type="number" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6 @error('national_id') is-invalid @enderror"
                 name="national_id" value="{{ old('national_id')  ?? $doctor->national_id }}"  autocomplete="national_id"  placeholder="@lang('National ID')">
                @error('national_id')
                    <div class="fv-plugins-message-container">
                        <div class="fv-help-block">
                            <strong>{{ $message }}</strong>
             ...
             <div class="form-group">
                 <input id="text" type="phone" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6 @error('phone') is-invalid @enderror"
                  name="phone" value="{{ old('phone') ?? $doctor->user->phone }}"  autocomplete="phone"  placeholder="@lang('phone')">
                 @error('phone')
                     <div class="fv-plugins-message-container">
                         <div class="fv-help-block">
                             <strong>{{ $message }}</strong>
             ...
             <div class="form-group">
                 <input id="whats_app" type="phone" class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6 @error('whats_app') is-invalid @enderror"
                  name="whats_app" value="{{ old('whats_app') ?? $doctor->user->whats_app  }}" autocomplete="whats_app"  placeholder="@lang('Whatsapp')">
                 @error('whats_app')
                     <div class="fv-plugins-message-container">
                         <div class="fv-help-block">
                             <strong>{{ $message }}</strong>
             ...
             <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{ old('brief_desc') ?? $doctor->brief_desc }}
                    </textarea>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    placeholder="@lang('Write description')" required>
                    {{ old('brief_desc_ar') ?? $doctor->brief_desc_ar }}
                    </textarea>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    name="facebook"  placeholder="@lang('Link')"  value="{{old("facebook") ?? $doctor->facebook}}"/>
                    @error('facebook')
             ...
             <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="image-input image-input-empty image-input-outline" id="avatar_id" style="background-image: url({{ view_image($doctor->avatar) ?? asset('media/svg/logos/Logo.jpg') }})">
                        <div class="image-input-wrapper"></div>
                        <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                            <i class="fas fa-pen icon-sm text-muted"></i>
                            <input type="file" name="avatar_id" accept=".png, .jpg, .jpeg ,gif,svg"   />
