...
class PatientDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('user.phone', '{{ $user["phone"]}}')
            ->addColumn('checkbox', 'dashboard.Patient.btn.checkbox')
            ->addColumn('action', 'dashboard.Patient.btn.action')
    ...
    {
        return Patient::query()->with(['user'])->select("patients.*");
    }
